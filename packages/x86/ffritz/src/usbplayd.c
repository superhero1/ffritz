...
main (int argc, char **argv)
{
	...
	static struct option long_options[] = {
	    ...
	    {"altpipe", required_argument, 0, 'P'},
	    {"help", 0, 0, 'h'},
	    {0, 0, 0, 0}
	};

	c = getopt_long (argc, argv, "hd:s:v:V:P:", long_options, &option_index);
	...
	for (i = 0; i < nfds; i++)
	{
	    ...
	    ret = read (pfd[i].fd, buf, sizeof (buf));
